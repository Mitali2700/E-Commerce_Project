  ...
  return (
    ...
    thumbnail: 'https://i.dummyjson.com/data/products/27/thumbnail.webp', */}
              ...
              {allProduct?.map((products) => (
                <ProductCard title={products.title} id={products.id} description={products.description} price={products.price} thumbnail={products.thumbnail} discountPercentage={products.discountPercentage} rating={products.rating} stock={products.stock} brand={products.b} category={''} />
              ))}
